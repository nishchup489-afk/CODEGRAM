                            ...
                            >

                                {
                                    profileData.github_url && (
                                        ...
                                        <a
                                            href={openExternal(profileData.github_url)}
                                            target="_blank"
                                            rel="noreferrer"
                                            className="
                                                flex
...

                                {
                                    profileData.linkedin_url && (
                                        ...
                                        <a
                                            href={openExternal(profileData.linkedin_url)}
                                            target="_blank"
                                            rel="noreferrer"
                                            className="
                                                flex
...

                                {
                                    profileData.portfolio_url && (
                                        ...
                                        <a
                                            href={openExternal(profileData.portfolio_url)}
                                            target="_blank"
                                            rel="noreferrer"
                                            className="
                                                flex
                                ...
                                isOwner && (
                                    ...
                                    <div className="mt-5">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() =>
                                                router.push(`/dashboard/profile/edit/${profileData.username}`)
                                            }
                                            className="
                                                flex
                                                w-full
